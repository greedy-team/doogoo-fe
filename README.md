...
# 📅 Sejong D-Cal
### 세종대 맞춤형 두드림 캘린더 구독 서비스 ![실시간 방문자](http://152.67.211.137:3000/badge)
...
| 기능 | 설명 |
|------|------|
| 🎓 학사일정 필터링 | 학년(1~4학년, 대학원 등) 기준 학사일정 필터링 |
