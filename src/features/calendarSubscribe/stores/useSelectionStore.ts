...
export const useSelectionStore = create<SelectionState>((set) => ({
    ...
    setGrades: (grades: string[]) => set({ selectedGrades: grades }),
    setDepartments: (departments: string[]) => set({ selectedDepartments: departments }),
    setKeywords: (keywords: string[]) => set({ selectedKeywords: keywords }),
