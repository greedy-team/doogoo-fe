...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'group/calendar bg-background p-0 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent',
      ...
      classNames={{
        ...
        day: cn(
          'group/day relative aspect-square min-h-(--cell-size) w-full p-0 text-center select-none [&:last-child[data-selected=true]_button]:rounded-r-md',
